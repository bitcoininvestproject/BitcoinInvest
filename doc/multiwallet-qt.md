...
In order to support loading of multiple wallets in bitcoininvest-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoininvest.cpp.
...
Changes to bitcoininvest.cpp
----------------------
bitcoininvest.cpp is the entry point into bitcoininvest-qt, and as such, will require some minor modifications to provide hooks for
