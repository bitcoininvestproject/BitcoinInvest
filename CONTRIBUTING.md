Contributing to BitcoinInvest Core
==================================

The BitcoinInvest Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BitcoinInvest Core project, and is not to be
confused with overall BitcoinInvest Network Protocol consensus changes.

Whether a pull request is merged into BitcoinInvest Core rests with the project merge
...
Patches that change BitcoinInvest consensus rules are considerably more involved than
...
Where a patch set proposes to change the BitcoinInvest consensus, it must have been
...
The project leader is the release manager for each BitcoinInvest Core release.
