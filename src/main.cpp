...
#if defined(NDEBUG)
#error "BitcoinInvest cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ubtv) are considered zero fee (for relaying and mining)
...
{
    RenameThread("bitcoininvest-scriptch");
