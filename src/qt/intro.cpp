...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinInvest Core"),
     ...
     * override -datadir in the bitcoininvest.conf file in the default data directory
     * (to be consistent with bitcoininvestd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
