...
/** Utility functions used by the BitcoinInvest Qt UI.
 */
namespace GUIUtil
{
...
// Render BTV addresses in monospace font
...
// Parse "bitcoininvest:" URI into recipient object, return true on successful parsing
