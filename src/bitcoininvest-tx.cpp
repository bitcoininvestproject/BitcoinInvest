...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitcoinInvest Core bitcoininvest-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoininvest-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoininvest transaction") + "\n" +
                               "  bitcoininvest-tx [options] -create [commands]   " + _("Create hex-encoded bitcoininvest transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoininvest transaction
