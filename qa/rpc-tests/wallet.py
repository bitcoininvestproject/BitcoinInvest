...
#   c) node1 mines 32 blocks, so now node 0 has 500000BTV, node 1 has 4250BTV, node2 has none.
#   d) node0 sends 601 BTV to node2, in two transactions (301 BTV, then 300 BTV).
